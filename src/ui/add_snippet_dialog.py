...
class AddSnippetDialog(wx.Dialog):
    ...
    def __init__(self, parent, data):
        super().__init__(parent, title="Add Snippet")
        ...
        contents_label = wx.StaticText(self, label="Contents:")
    ...
    def ok_button_clicked(self, event):
        ...
        if name and contents:
            ...
            wx.MessageBox("Please enter a name and contents for the snippet.", "Error", wx.OK | wx.ICON_ERROR)
